...
public final class AudioDeviceEnumerator: @unchecked Sendable {
    ...
    /// Set this closure to be notified of hot-plug events. Called on the main thread.
    nonisolated(unsafe) public var onDeviceListChanged: (@Sendable () -> Void)?
    ...
    private func installDeviceChangeListener() {
        let block: AudioObjectPropertyListenerBlock = { [weak self] _, _ in
            let callback = self?.onDeviceListChanged
